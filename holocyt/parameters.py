...
P = [
    ...
    Parameter("centroid_x_px", "Центр масс X", "пикселей", DIRECT,
              "Centroid position x", APPROXIMATES),
    Parameter("centroid_y_px", "Центр масс Y", "пикселей", DIRECT,
              "Centroid position y", APPROXIMATES),
    Parameter("peak_x_px", "Положение пика X", "пикселей", DIRECT,
              "Peak position", APPROXIMATES),
    Parameter("peak_y_px", "Положение пика Y", "пикселей", DIRECT,
              "Peak position", APPROXIMATES),
    ...
    Parameter("bbox_breadth_um", "Ширина габарита", "мкм", CALIBRATED,
              "Boxed breadth", APPROXIMATES),
    Parameter("centroid_x_um", "Центр масс X", "мкм", CALIBRATED,
              "Centroid position x", APPROXIMATES),
    Parameter("centroid_y_um", "Центр масс Y", "мкм", CALIBRATED,
              "Centroid position y", APPROXIMATES),
